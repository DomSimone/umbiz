...
# Run the download script during build to bake the model into the image
# This will download the model to /root/.cache/huggingface/hub
# If the model is private, you must pass --build-arg HF_TOKEN=your_token during build
ARG HF_TOKEN
